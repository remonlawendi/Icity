function Footer() {
    return (
            ...
            <div className="row">
              <div className="col-lg-4 col-md-12 col-sm-12 column">
                <div className="footer_about_content">
                  ...
                  <a className="view_more" href="(0)">View More</a> </div>
              </div>
              ...
              <div className="col-lg-6 offset-md-2 col-md-5 col-sm-5 col-xs-12 column">
                ...
                <div className="contact_info">
                  ...
                  <div className="follow_us_on"> <a href="(0)"><i className="flat flaticon-facebook-logo"></i></a> <a href="(0)"><i className="flat flaticon-twitter"></i></a> <a href="(0)"><i className="flat flaticon-google-plus-logo"></i></a> <a href="(0)"><i className="flat flaticon-linkedin-logo"></i></a> <a href="(0)"><i className="flat flaticon-instagram"></i></a> </div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="row">
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right"> <a href="(0)">Privacy Policy</a>
                  <span className="separator-pipesign"></span>
